        ...
        let html = `
            <div class="statement-header">
                <div class="company-info">
                    <h3>${data.company.company_name} - ${data.company.company_name_ar}</h3>
                </div>
        ...
        return `
            ...
            <body>
                <div class="print-header">
                    <div class="company-info">
                        <h1>${data.company.company_name_ar}</h1>
                ...
                <div class="print-footer">
                    <p>تم إنشاء هذا التقرير بواسطة نظام ${data.company.company_name_ar}</p>
                    <p>Generated by ${data.company.company_name} System - ${frappe.datetime.now_datetime()}</p>
                </div>
            </body>
            </html>
        `;
